...
class GLGradientButton extends StatefulWidget {
  const GLGradientButton(
    this.text, {
  ...
  @override
  _GLGradientButtonState createState() => _GLGradientButtonState();
}

class _GLGradientButtonState extends State<GLGradientButton> {
  bool onHover = false;
            ...
            children: <Widget>[
              ...
              if (!widget.showLoading)
                Align(
                  alignment: Alignment.center,
                  child: Text(
                    StringUtils.capitalize(widget.text),
                    maxLines: 1,
                    style: TextStyle(
